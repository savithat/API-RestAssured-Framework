    ...
    stages 
    {
        ...
        stage('Regression API Automation Test') {
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    sh "mvn clean test -Dsurefire.suiteXmlFiles=src/test/resouces/testrunners/testng_regression.xml"
        ...
        stage('Sanity Automation Test') {
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    git 'https://github.com/savthi/API-RestAssured-Framework.git'
                    sh "mvn clean test -Dsurefire.suiteXmlFiles=src/test/resouces/testrunners/testng_sanity.xml"
